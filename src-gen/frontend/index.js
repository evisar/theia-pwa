...
module.exports = Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('@theia/docker/lib/browser/docker-frontend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@theia/go/lib/browser/go-frontend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@theia/php/lib/browser/theia-php-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@theia/preview/lib/browser/preview-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@theia/plantuml/lib/browser/plantuml-frontend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@theia/ruby/lib/browser/ruby-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@theia/rust/lib/browser/rust-frontend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('theia-sprotty/lib/theia/diagram-module')).then(load) })
    .then(function () { return Promise.resolve(require('theia-yang-extension/lib/frontend/language/frontend-extension')).then(load) })
