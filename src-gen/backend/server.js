...
module.exports = (port, host, argv) => Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('@theia/docker/lib/node/docker-backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@theia/editorconfig/lib/node/editorconfig-backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@theia/extension-manager/lib/node/extension-backend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@theia/php/lib/node/theia-php-backend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@theia/ruby/lib/node/ruby-backend-module')).then(load) })
