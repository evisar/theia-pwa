define('vs/language/html/monaco.contribution',["require", "exports"], function (require, exports) {
    /*---------------------------------------------------------------------------------------------
    ...
    function getMode() {
        return monaco.Promise.wrap(new Promise(function (resolve_1, reject_1) { require(['./htmlMode'], resolve_1, reject_1); }));
    }
