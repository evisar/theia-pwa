...
export function getHTML5TagProvider() {
...
export function getAngularTagProvider() {
    var customTags = {
...
export function getIonicTagProvider() {
    var customTags = {
