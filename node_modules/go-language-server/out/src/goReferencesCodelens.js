...
const utils_1 = require("../src-vscode-mock/utils");
const vscode_1 = require("../src-vscode-mock/vscode");
    ...
    resolveCodeLens(inputCodeLens, token) {
        ...
        return referenceProvider.provideReferences(codeLens.document, codeLens.range.start, options, token).then(references => {
            codeLens.command = {
                ...
                arguments: [utils_1.uriToStringUri(codeLens.document.uri), codeLens.range.start, references]
            };
            return codeLens;
        }, err => {
            console.log(err);
