...
import { Position, CompletionItem, Range, CodeActionContext, Command, TextDocumentIdentifier, Location, DocumentHighlight, SymbolInformation, SignatureHelp, DocumentLink, TextEdit, Hover, FormattingOptions, Diagnostic } from "vscode-languageserver-types";
...
export declare class LanguageService implements DockerfileLanguageService {
    ...
    private logger;
    private completionDocumentationFormat;
