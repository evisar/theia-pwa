...
import { AnchorPosition } from '../contextview/contextview';
...
var SelectBoxList = /** @class */ (function () {
        ...
        if (this.selectList) {
            ...
            if (preLayoutPosition) {
                ...
                if (listHeight + verticalPadding > maxSelectDropDownHeight) {
                    var maxVisibleOptions = ((Math.floor((maxSelectDropDownHeight - verticalPadding) / this.getHeight())));
    ...
    SelectBoxList.DEFAULT_DROPDOWN_MINIMUM_TOP_MARGIN = 42;
