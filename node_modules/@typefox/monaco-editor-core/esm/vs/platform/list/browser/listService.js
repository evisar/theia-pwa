...
var _a;
import { List, isSelectionRangeChangeEvent, isSelectionSingleChangeEvent, DefaultStyleController } from '../../../base/browser/ui/list/listWidget';
import { createDecorator, IInstantiationService } from '../../instantiation/common/instantiation';
import { toDisposable, combinedDisposable, dispose, Disposable } from '../../../base/common/lifecycle';
import { IContextKeyService, RawContextKey, ContextKeyExpr } from '../../contextkey/common/contextkey';
import { PagedList } from '../../../base/browser/ui/list/listPaging';
import { Tree } from '../../../base/parts/tree/browser/treeImpl';
import { attachListStyler, defaultListStyles, computeStyles, attachInputBoxStyler } from '../../theme/common/styler';
...
import { createStyleSheet, addStandardDisposableListener, getTotalHeight, removeClass, addClass } from '../../../base/browser/dom';
...
import { onUnexpectedError, canceled } from '../../../base/common/errors';
...
var HighlightingTreeController = /** @class */ (function (_super) {
    ...
    function HighlightingTreeController(options, onType, configurationService) {
...
var HighlightingWorkbenchTree = /** @class */ (function (_super) {
    ...
    function HighlightingWorkbenchTree(parent, treeConfiguration, treeOptions, listOptions, contextKeyService, contextViewService, listService, themeService, instantiationService, configurationService) {
        ...
        _this = _super.call(this, treeContainer, treeConfiguration, treeOptions, contextKeyService, listService, themeService, instantiationService, configurationService) || this;
        _this.renderer = treeConfiguration.renderer;
    ...
    HighlightingWorkbenchTree.prototype.updateHighlights = function (pattern) {
        ...
        var topElement = this.renderer.updateHighlights(this, pattern);
