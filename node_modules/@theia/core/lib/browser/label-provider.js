...
var LabelProvider = /** @class */ (function () {
    function LabelProvider(contributionProvider) {
    ...
    LabelProvider = __decorate([
        inversify_1.injectable(),
        __param(0, inversify_1.inject(contribution_provider_1.ContributionProvider)), __param(0, inversify_1.named(exports.LabelProviderContribution)),
