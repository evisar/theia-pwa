...
describe('fuzzy-search', function () {
    [
        ...
        it("should match " + expected.length + " item" + (expected.length === 1 ? '' : 's') + " when filtering [" + items.join(', ') + "] with pattern: '" + pattern + "'", function () { return __awaiter(_this, void 0, void 0, function () {
            var _a;
    ...
    [
        ...
        it("should match the order of items after the filtering with pattern: '" + pattern + "'", function () { return __awaiter(_this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
