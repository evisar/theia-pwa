...
var FuzzySearch = /** @class */ (function () {
     ...
     */
    FuzzySearch.prototype.filter = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fuzzy.filter(input.pattern, input.items.slice(), {
    ...
    FuzzySearch.prototype.sortResults = function (left, right) {
        return left.index - right.index;
    };
    FuzzySearch.prototype.mapResult = function (result) {
        return {
            item: result.original,
            ranges: this.mapRanges(result.string)
        };
    };
    FuzzySearch.prototype.mapRanges = function (input) {
        var copy = input.split('').filter(function (s) { return s !== ''; });
        var ranges = [];
        var validate = function (pre, post) {
            if (preIndex > postIndex || (preIndex === -1) !== (postIndex === -1)) {
                throw new Error("Error when trying to map ranges. Escaped string was: '" + input + ". [" + __spread(input).join('|') + "]'");
            }
        };
        var preIndex = copy.indexOf(FuzzySearch_1.PRE);
        var postIndex = copy.indexOf(FuzzySearch_1.POST);
