...
var HttpOpenHandler = /** @class */ (function () {
    function HttpOpenHandler() {
        this.id = 'http';
    }
    HttpOpenHandler.prototype.canHandle = function (uri) {
        return uri.scheme.startsWith('http') ? 500 : 0;
    };
    HttpOpenHandler.prototype.open = function (uri) {
        return window.open(uri.toString(true)) || undefined;
    };
    HttpOpenHandler = __decorate([
        inversify_1.injectable()
    ], HttpOpenHandler);
    return HttpOpenHandler;
}());
