...
var MessagingContribution = /** @class */ (function () {
            ...
            try {
                ...
                if (message.kind === 'open') {
                    ...
                    if (channelHandlers.route(path, channel)) {
                        ...
                        channel.onClose(function () { return channels.delete(id_1); });
                    }
                    else {
    ...
    __decorate([
        inversify_1.inject(common_1.ContributionProvider), inversify_1.named(connection_container_module_1.ConnectionContainerModule),
        __metadata("design:type", Object)
    ], MessagingContribution.prototype, "connectionModules", void 0);
    __decorate([
        inversify_1.inject(common_1.ContributionProvider), inversify_1.named(messaging_service_1.MessagingService.Contribution),
        __metadata("design:type", Object)
