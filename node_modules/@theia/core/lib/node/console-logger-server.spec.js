...
var server;
var logLevelCliContribution;
var MockLogLevelCliContribution = /** @class */ (function (_super) {
    __extends(MockLogLevelCliContribution, _super);
    function MockLogLevelCliContribution() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MockLogLevelCliContribution.prototype.init = function () {
        this._logLevels['test-logger'] = logger_protocol_1.LogLevel.DEBUG;
    };
    MockLogLevelCliContribution.prototype.changeLogLevel = function (newLevel) {
    ...
    return MockLogLevelCliContribution;
}(logger_cli_contribution_1.LogLevelCliContribution));
beforeEach(function () {
...
describe('ConsoleLoggerServer', function () {
    it('should respect log level config', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = chai_1.expect;
                        return [4 /*yield*/, server.getLogLevel('test-logger')];
                    case 1:
                        _a.apply(void 0, [_d.sent()]).eq(logger_protocol_1.LogLevel.DEBUG);
                        return [4 /*yield*/, server.child('test-logger')];
                    case 2:
                        _d.sent();
                        _b = chai_1.expect;
                        return [4 /*yield*/, server.getLogLevel('test-logger')];
                    case 3:
                        _b.apply(void 0, [_d.sent()]).eq(logger_protocol_1.LogLevel.DEBUG);
                        logLevelCliContribution.changeLogLevel(logger_protocol_1.LogLevel.WARN);
                        _c = chai_1.expect;
                        return [4 /*yield*/, server.getLogLevel('test-logger')];
                    case 4:
                        _c.apply(void 0, [_d.sent()]).eq(logger_protocol_1.LogLevel.WARN);
                        return [2 /*return*/];
                }
            });
        });
