...
var LogLevelCliContribution = /** @class */ (function () {
    ...
    LogLevelCliContribution.prototype.watchLogConfigFile = function (filename) {
        ...
        return nsfw(filename, function (events) { return __awaiter(_this, void 0, void 0, function () {
            var e_2, _a, events_1, events_1_1, event_2, _b, e_2_1, e_3;
    ...
    LogLevelCliContribution.prototype.slurpLogConfigFile = function (filename) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4, _a, content, data, newDefaultLogLevel, newLogLevels, loggers, _b, _c, logger, levelStr, e_5;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if ('levels' in data) {
                            loggers = data['levels'];
                            try {
                                for (_b = __values(Object.keys(loggers)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    logger = _c.value;
                    ...
                    case 2:
                        e_5 = _d.sent();
                        throw new Error("Error reading log config file " + filename + ": " + e_5.message);
