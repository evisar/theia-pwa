...
(function (Command) {
    ...
    function compareCommands(a, b) {
        if (a.label && b.label) {
            var aCommand = (a.category) ? a.category + a.label : a.label;
            var bCommand = (b.category) ? b.category + b.label : b.label;
...
var CommandRegistry = /** @class */ (function () {
    ...
    CommandRegistry.prototype.isToggled = function (command) {
        var handler = this.getToggledHandler(command);
    ...
    CommandRegistry.prototype.executeCommand = function (command) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        handler = this.getActiveHandler.apply(this, __spread([command], args));
