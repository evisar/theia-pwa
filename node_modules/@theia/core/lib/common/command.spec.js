...
describe('Commands', function () {
    it('should properly pass arguments when any', function () { return __awaiter(_this, void 0, void 0, function () {
        var commandRegistry, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    commandRegistry = new command_1.CommandRegistry(new EmptyContributionProvider());
                    // Registering a concat command to test
                    commandRegistry.registerCommand({ id: 'concat' }, new ConcatCommandHandler());
                    _b = (_a = expect('commandarg1_commandarg2_commandarg3')).equals;
                    return [4 /*yield*/, commandRegistry.executeCommand('concat', 'commandarg1', '_commandarg2', '_commandarg3')];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
