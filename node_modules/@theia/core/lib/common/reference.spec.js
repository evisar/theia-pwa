...
describe('reference', function () {
    it('dispose a single reference', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('dispose 2 references', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('dispose an object with 2 references', function () { return __awaiter(_this, void 0, void 0, function () {
        var expectation, references, reference;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("shouldn't call onWillDispose event on create", function () { return __awaiter(_this, void 0, void 0, function () {
        var expectation, references, reference;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('the same object should be provided by an async factory for the same key', function () { return __awaiter(_this, void 0, void 0, function () {
        var references, result;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    references = new reference_1.ReferenceCollection(function (key) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, ({
                                    key: key, dispose: function () {
                                    }
