...
var CppBuildConfigurationChanger = /** @class */ (function () {
    function CppBuildConfigurationChanger() {
        var _this = this;
        this.createItem = new quick_open_model_1.QuickOpenItem({
            label: 'Create New',
        ...
        this.resetItem = new quick_open_model_1.QuickOpenItem({
            label: 'None',
            ...
            run: function (mode) {
                ...
                _this.cppBuildConfigurations.setActiveConfig(undefined);
                return true;
            },
        });
    }
    CppBuildConfigurationChanger.prototype.onType = function (lookFor, acceptor) {
        return __awaiter(this, void 0, void 0, function () {
            var items, active, configurations, homeStat, home;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        configurations = this.cppBuildConfigurations.getValidConfigs();
                    ...
                    case 1:
                        ...
                        if (!configurations.length) {
                            return [2 /*return*/, acceptor(items)];
                        }
                        ...
                        configurations.forEach(function (config) {
                            var uri = new uri_1.default(config.directory);
                            items.push(new quick_open_model_1.QuickOpenItem({
                                ...
                                description: (home) ? common_1.FileSystemUtils.tildifyPath(uri.path.toString(), home) : uri.path.toString(),
                                run: function (mode) {
                                    if (mode !== quick_open_model_1.QuickOpenMode.OPEN) {
                                        return false;
                                    }
                                    _this.cppBuildConfigurations.setActiveConfig(config);
                                    return true;
                                },
                            }));
                        });
    ...
    CppBuildConfigurationChanger.prototype.open = function () {
        var configs = this.cppBuildConfigurations.getValidConfigs();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        configs = this.cppBuildConfigurations.getConfigs();
                        newConfigs = configs.slice(0);
                        newConfigs.push({ name: '', directory: '' });
                        return [4 /*yield*/, this.preferenceService.set(cpp_build_configurations_1.CPP_BUILD_CONFIGURATIONS_PREFERENCE_KEY, newConfigs, browser_1.PreferenceScope.Workspace)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var CppBuildConfigurationsContributions = /** @class */ (function () {
    ...
    CppBuildConfigurationsContributions.prototype.registerCommands = function (commands) {
        ...
        commands.registerCommand(exports.CPP_CHANGE_BUILD_CONFIGURATION, {
            execute: function () { return _this.cppChangeBuildConfiguration.open(); }
        });
    };
    __decorate([
