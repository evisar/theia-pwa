...
var SavedActiveBuildConfiguration = /** @class */ (function () {
    function SavedActiveBuildConfiguration() {
    }
    return SavedActiveBuildConfiguration;
}());
...
var CppBuildConfigurationManagerImpl = /** @class */ (function () {
    function CppBuildConfigurationManagerImpl() {
        ...
        this.ACTIVE_BUILD_CONFIGURATION_STORAGE_KEY = 'cpp.active-build-configuration';
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.ready = new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.cppPreferences.ready];
                            case 1:
                                _a.sent();
    ...
    CppBuildConfigurationManagerImpl.prototype.loadActiveConfiguration = function () {
        return __awaiter(this, void 0, void 0, function () {
            var savedConfig, configs, config;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storageService.getData(this.ACTIVE_BUILD_CONFIGURATION_STORAGE_KEY)];
                    case 1:
                        savedConfig = _a.sent();
                        if (savedConfig !== undefined && savedConfig.configName !== undefined) {
                            configs = this.getConfigs();
                            config = configs.find(function (cfg) { return savedConfig.configName === cfg.name; });
                            if (config) {
     ...
     */
    CppBuildConfigurationManagerImpl.prototype.saveActiveConfiguration = function (config) {
        this.storageService.setData(this.ACTIVE_BUILD_CONFIGURATION_STORAGE_KEY, {
            configName: config ? config.name : undefined,
        });
    };
    CppBuildConfigurationManagerImpl.prototype.getActiveConfig = function () {
        return this.activeConfig;
    };
    CppBuildConfigurationManagerImpl.prototype.setActiveConfig = function (config) {
    ...
    CppBuildConfigurationManagerImpl.prototype.getConfigs = function () {
        return this.cppPreferences[exports.CPP_BUILD_CONFIGURATIONS_PREFERENCE_KEY] || [];
    };
    CppBuildConfigurationManagerImpl.prototype.getValidConfigs = function () {
