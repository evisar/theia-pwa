...
var WorkspaceStorageService = /** @class */ (function () {
    ...
    WorkspaceStorageService.prototype.init = function () {
        var _this = this;
        this.initialized = this.workspaceService.roots.then(function (roots) {
            _this.prefix = _this.getPrefix(roots[0]);
        });
    };
    ...
    WorkspaceStorageService.prototype.getPrefix = function (rootStat) {
