...
var DefaultWorkspaceServer = /** @class */ (function () {
    ...
    DefaultWorkspaceServer.prototype.workspaceStillExist = function (wspath) {
        return fs.pathExistsSync(node_1.FileUri.fsPath(wspath));
    };
    ...
    DefaultWorkspaceServer.prototype.writeToFile = function (filePath, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fs.mkdirs(path.resolve(filePath, '..'))];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, fs.writeJson(filePath, data)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DefaultWorkspaceServer.prototype.readRecentWorkspacePathsFromUserHome = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filePath = this.getUserStoragePath();
                        return [4 /*yield*/, this.readJsonFromFile(filePath)];
                    case 1:
                        data = _a.sent();
    ...
    DefaultWorkspaceServer.prototype.readJsonFromFile = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
