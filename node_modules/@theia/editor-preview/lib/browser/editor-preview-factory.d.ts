...
export declare class EditorPreviewWidgetFactory implements WidgetFactory {
    static ID: string;
    ...
    protected doCreate(options: EditorPreviewWidgetOptions): Promise<EditorPreviewWidget>;
}
//# sourceMappingURL=editor-preview-factory.d.ts.map