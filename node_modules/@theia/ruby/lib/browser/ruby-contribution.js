...
var RubyClientContribution = /** @class */ (function (_super) {
    __extends(RubyClientContribution, _super);
    function RubyClientContribution(workspace, languages, languageClientFactory) {
        ...
        _this.id = common_1.RUBY_LANGUAGE_ID;
        _this.name = common_1.RUBY_LANGUAGE_NAME;
        return _this;
    }
    Object.defineProperty(RubyClientContribution.prototype, "globPatterns", {
        get: function () {
            return [
                '**/*.rb',
                '**/*.rbx',
    ...
    RubyClientContribution = __decorate([
    ...
    ], RubyClientContribution);
    return RubyClientContribution;
}(browser_1.BaseLanguageClientContribution));
exports.RubyClientContribution = RubyClientContribution;
