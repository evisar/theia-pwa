...
export declare class PluginDebugAdapterSession extends DebugAdapterSessionImpl implements theia.DebugSession {
    ...
    constructor(id: string, configuration: theia.DebugConfiguration, communicationProvider: CommunicationProvider, customRequest: (command: string, args?: any) => Promise<DebugProtocol.Response>);
}
