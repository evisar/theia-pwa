...
var DiagnosticCollection = /** @class */ (function () {
    ...
    DiagnosticCollection.prototype.set = function (arg, diagnostics) {
        ...
        if (arg instanceof vscode_uri_1.default) {
    ...
    DiagnosticCollection.prototype.toUrisArray = function (arg) {
        ...
        if (arg instanceof Array) {
            ...
            if (arg[0] instanceof vscode_uri_1.default) {
                return arg;
            }
            else {
                var result = [];
                try {
                    for (var _b = __values(arg), _c = _b.next(); !_c.done; _c = _b.next()) {
                        ...
                        result.push(vscode_uri_1.default.parse(uriString));
                    }
                }
        ...
        var _loop_1 = function (uri) {
            ...
            if (uriDiagnostics) {
                if (uriDiagnostics.length > this_1.diagnosticsLimitPerResource) {
                    try {
                        for (var _c = __values(DiagnosticCollection.DIAGNOSTICS_PRIORITY), _d = _c.next(); !_d.done; _d = _c.next()) {
                            var severity = _d.value;
                            try {
                                for (var uriDiagnostics_1 = __values(uriDiagnostics), uriDiagnostics_1_1 = uriDiagnostics_1.next(); !uriDiagnostics_1_1.done; uriDiagnostics_1_1 = uriDiagnostics_1.next()) {
