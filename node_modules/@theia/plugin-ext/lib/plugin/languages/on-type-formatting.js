...
var OnTypeFormattingAdapter = /** @class */ (function () {
    ...
    OnTypeFormattingAdapter.prototype.provideOnTypeFormattingEdits = function (resource, position, ch, options) {
        ...
        return Promise.resolve(this.provider.provideOnTypeFormattingEdits(doc, pos, ch, options, token_provider_1.createToken())).then(function (value) {
...
//# sourceMappingURL=on-type-formatting.js.map