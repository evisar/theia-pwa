...
var ColorProviderAdapter = /** @class */ (function () {
    ...
    ColorProviderAdapter.prototype.provideColors = function (resource) {
        ...
        return Promise.resolve(this.provider.provideDocumentColors(doc, token_provider_1.createToken())).then(function (colors) {
    ...
    ColorProviderAdapter.prototype.provideColorPresentations = function (resource, raw) {
        ...
        return Promise.resolve(this.provider.provideColorPresentations(color, { document: doc, range: range }, token_provider_1.createToken())).then(function (value) {
