...
var LinkProviderAdapter = /** @class */ (function () {
    ...
    LinkProviderAdapter.prototype.provideLinks = function (resource) {
        ...
        return Promise.resolve(this.provider.provideDocumentLinks(doc, token_provider_1.createToken())).then(function (links) {
            var e_1, _a;
    ...
    LinkProviderAdapter.prototype.resolveLink = function (link) {
        ...
        return Promise.resolve(this.provider.resolveDocumentLink(item, undefined)).then(function (value) {
            if (value) {
