...
var DocumentHighlightAdapter = /** @class */ (function () {
    ...
    DocumentHighlightAdapter.prototype.provideDocumentHighlights = function (resource, position) {
        ...
        return Promise.resolve(this.provider.provideDocumentHighlights(document, zeroBasedPosition, token_provider_1.createToken())).then(function (documentHighlights) {
            var e_1, _a;
