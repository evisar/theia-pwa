...
var WorkspaceSymbolAdapter = /** @class */ (function () {
    ...
    WorkspaceSymbolAdapter.prototype.provideWorkspaceSymbols = function (query) {
        return Promise.resolve(this.provider.provideWorkspaceSymbols(query, token_provider_1.createToken())).then(function (workspaceSymbols) {
            var e_1, _a;
            if (!workspaceSymbols) {
                return [];
            }
    ...
    WorkspaceSymbolAdapter.prototype.resolveWorkspaceSymbol = function (symbol) {
        if (this.provider.resolveWorkspaceSymbol && typeof this.provider.resolveWorkspaceSymbol === 'function') {
            ...
            if (!theiaSymbol) {
                ...
                return Promise.resolve(this.provider.resolveWorkspaceSymbol(theiaSymbol, undefined)).then(function (workspaceSymbol) {
                    if (!workspaceSymbol) {
                        return symbol;
                    }
