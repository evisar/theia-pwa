...
export declare type FileChangeEventType = 'created' | 'updated' | 'deleted';
...
export declare type SnippetType = 'internal' | 'textmate';
...
export declare type CompletionType = 'method' | 'function' | 'constructor' | 'field' | 'variable' | 'class' | 'struct' | 'interface' | 'module' | 'property' | 'event' | 'operator' | 'unit' | 'value' | 'constant' | 'enum' | 'enum-member' | 'keyword' | 'snippet' | 'text' | 'color' | 'file' | 'reference' | 'customcolor' | 'folder' | 'type-parameter';
