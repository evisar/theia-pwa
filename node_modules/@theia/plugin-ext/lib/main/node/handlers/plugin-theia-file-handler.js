...
var PluginTheiaFileHandler = /** @class */ (function () {
    function PluginTheiaFileHandler() {
        this.unpackedFolder = temp_dir_util_1.getTempDir('theia-unpacked');
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        unpackedPath = path.resolve(this.unpackedFolder, path.basename(context.pluginEntry().path()));
                        return [4 /*yield*/, context.unzip(context.pluginEntry().path(), unpackedPath)];
                    case 1:
                        _a.sent();
