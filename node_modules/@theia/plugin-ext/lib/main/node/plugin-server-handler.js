...
var PluginServerHandler = /** @class */ (function () {
    ...
    PluginServerHandler.prototype.deploy = function (pluginEntry) {
        return this.pluginDeployer.deploy(pluginEntry);
    };
    PluginServerHandler.prototype.keyValueStorageSet = function (key, value, isGlobal) {
        return this.pluginsKeyValueStorage.set(key, value, isGlobal);
    };
    PluginServerHandler.prototype.keyValueStorageGet = function (key, isGlobal) {
        return this.pluginsKeyValueStorage.get(key, isGlobal);
    };
    PluginServerHandler.prototype.keyValueStorageGetAll = function (isGlobal) {
