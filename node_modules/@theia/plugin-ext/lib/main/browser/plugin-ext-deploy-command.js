...
var PluginExtDeployCommandService = /** @class */ (function () {
    ...
    ], PluginExtDeployCommandService.prototype, "hostedPluginSupport", void 0);
    __decorate([
        inversify_1.inject(plugin_ext_widget_1.PluginWidget),
        __metadata("design:type", plugin_ext_widget_1.PluginWidget)
    ], PluginExtDeployCommandService.prototype, "pluginWidget", void 0);
...
var DeployQuickOpenItem = /** @class */ (function (_super) {
    ...
    function DeployQuickOpenItem(name, pluginServer, hostedPluginSupport, pluginWidget, description) {
        var _this = _super.call(this) || this;
        _this.name = name;
        _this.pluginServer = pluginServer;
        _this.hostedPluginSupport = hostedPluginSupport;
        _this.pluginWidget = pluginWidget;
    ...
    DeployQuickOpenItem.prototype.run = function (mode) {
        ...
        var promise = this.pluginServer.deploy(this.name);
        promise.then(function () {
            _this.hostedPluginSupport.initPlugins();
            _this.pluginWidget.refreshPlugins();
        });
        return true;
    };
