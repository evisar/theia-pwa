            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        proxy = this.rpc.getProxy(plugin_api_1.MAIN_RPC_CONTEXT.LANGUAGES_CONTRIBUTION_EXT);
                        // Asks the plugin to start the process of language server.
                        proxy.$start(this.languageContribution);
                        toDeactivate.push(core_2.Disposable.create(function () { return _this.stop = (function () { return __awaiter(_this, void 0, void 0, function () {
                            var _a;
