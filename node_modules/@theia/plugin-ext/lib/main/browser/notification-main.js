...
var NotificationMainImpl = /** @class */ (function () {
    function NotificationMainImpl(rpc, container) {
        ...
        this.proxy = rpc.getProxy(plugin_api_1.MAIN_RPC_CONTEXT.NOTIFICATION_EXT);
        this.messageService = container.get(common_1.MessageService);
    }
    NotificationMainImpl.prototype.$startProgress = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var deferredId, onDidClose, progress;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        deferredId = new promise_util_1.Deferred();
                        onDidClose = function () { return __awaiter(_this, void 0, void 0, function () { var _a, _b; return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.proxy).$onCancel;
                                    return [4 /*yield*/, deferredId.promise];
                                case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                            }
                        }); }); };
                        return [4 /*yield*/, this.messageService.showProgress({ text: message, options: { cancelable: true } }, onDidClose)];
                    case 1:
                        progress = _a.sent();
                        deferredId.resolve(progress.id);
                        this.progressMap.set(progress.id, progress);
                        this.incrementMap.set(progress.id, 0);
                        return [2 /*return*/, progress.id];
                }
            });
        });
    };
    ...
    NotificationMainImpl.prototype.$updateProgress = function (id, item) {
        ...
        var done;
        if (item.increment) {
            var increment = this.incrementMap.get(id);
