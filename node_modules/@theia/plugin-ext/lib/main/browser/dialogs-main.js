...
var DialogsMainImpl = /** @class */ (function () {
    function DialogsMainImpl(rpc, container) {
        ...
        this.labelProvider = container.get(browser_3.LabelProvider);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        rootStat = _a.sent();
                        _a.label = 6;
                    case 6: return [2 /*return*/, rootStat];
                }
            });
        });
    };
    DialogsMainImpl.prototype.$showOpenDialog = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var rootStat, rootUri, name, icon, rootNode, canSelectFiles, canSelectFolders, title, dialogProps, dialog, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        rootUri = new uri_1.default(rootStat.uri);
                        name = this.labelProvider.getName(rootUri);
                        return [4 /*yield*/, this.labelProvider.getIcon(rootUri)];
                    case 2:
                        icon = _a.sent();
                        rootNode = browser_1.DirNode.createRoot(rootStat, name, icon);
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
    ...
    DialogsMainImpl.prototype.$showSaveDialog = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var rootStat, rootUri, name, icon, rootNode, dialogProps, dialog, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRootUri(options.defaultUri ? options.defaultUri : undefined)];
                    case 1:
