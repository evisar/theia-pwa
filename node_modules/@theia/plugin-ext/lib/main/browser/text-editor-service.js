...
exports.TextEditorService = Symbol('TextEditorService');
var TextEditorServiceImpl = /** @class */ (function () {
    function TextEditorServiceImpl(editorManager) {
        var _this = this;
    ...
    TextEditorServiceImpl.prototype.listTextEditors = function () {
        return Array.from(this.editors.values());
    };
    TextEditorServiceImpl.prototype.getActiveEditor = function () {
        return this.editorManager.activeEditor;
    };
    TextEditorServiceImpl.prototype.onEditorChanged = function (editor) {
        // console.log(`Current Editor Changed: ${editor}`);
    };
    TextEditorServiceImpl.prototype.onEditorCreated = function (editor) {
        var _this = this;
    ...
    TextEditorServiceImpl.prototype.onEditorAdded = function (editor) {
    ...
    TextEditorServiceImpl.prototype.onEditorRemoved = function (editor) {
        if (this.editors.has(editor.getControl().getId())) {
            this.editors.delete(editor.getControl().getId());
            this.onTextEditorRemoveEmitter.fire(editor);
        }
    };
    TextEditorServiceImpl = __decorate([
        inversify_1.injectable(),
        __param(0, inversify_1.inject(browser_1.EditorManager)),
        __metadata("design:paramtypes", [browser_1.EditorManager])
    ], TextEditorServiceImpl);
    return TextEditorServiceImpl;
}());
exports.TextEditorServiceImpl = TextEditorServiceImpl;
