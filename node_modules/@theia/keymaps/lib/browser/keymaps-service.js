...
var KeymapsService = /** @class */ (function () {
    function KeymapsService() {
        this.changeKeymapEmitter = new common_2.Emitter();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.resourceProvider(new uri_1.default('keymaps.json').withScheme(browser_2.UserStorageUri.SCHEME))];
                    case 1:
                        _a.resource = _b.sent();
                        this.reconcile();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        keybindings = _a.sent();
                        this.keyBindingRegistry.setKeymap(browser_1.KeybindingScope.USER, keybindings);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        content = _a.sent();
                        return [2 /*return*/, this.parser.parse(content)];
                    case 2:
                        error_1 = _a.sent();
    ...
    KeymapsService.prototype.setKeybinding = function (keybindingJson) {
        return __awaiter(this, void 0, void 0, function () {
            var content, keybindings, updated, i, item;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        content = _a.sent();
                        keybindings = content ? jsoncparser.parse(content) : [];
                        updated = false;
    ...
    KeymapsService.prototype.removeKeybinding = function (commandId) {
        return __awaiter(this, void 0, void 0, function () {
            var content, keybindings, filtered;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.resource.saveContents) {
                    ...
                    case 1:
                        content = _a.sent();
                        keybindings = content ? jsoncparser.parse(content) : [];
                        filtered = keybindings.filter(function (a) { return a.command !== commandId; });
    ...
    KeymapsService.prototype.getKeybindings = function () {
        return __awaiter(this, void 0, void 0, function () {
            var content;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        content = _a.sent();
                        return [2 /*return*/, content ? jsoncparser.parse(content) : []];
                }
            });
        });
    };
    ...
    ], KeymapsService.prototype, "parser", void 0);
    __decorate([
