...
function compareSearchResults(expected, actual) {
    chai_1.expect(actual.length).eq(expected.length);
    ...
    var _loop_1 = function (i) {
        ...
        if (lines) {
            ...
            var a = actual.find(function (l) { return l.fileUri === e.fileUri && l.line === e.line && l.character === e.character; });
            chai_1.expect(a).deep.eq(e);
        }
        else {
