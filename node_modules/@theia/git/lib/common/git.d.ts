 ...
 * Git symbol for DI.
 */
export declare const Git: unique symbol;
...
export interface Git extends Disposable {
     ...
     */
    lsFiles(repository: Repository, uri: string, options: {
        errorUnmatch: true;
    }): Promise<boolean>;
    /**
...
export declare namespace GitUtils {
     ...
     */
    function isBranchRename(arg: any | undefined): arg is Git.Options.BranchCommand.Rename;
    /**
     * `true` if the argument is an option for deleting an existing branch in the repository.
     */
    function isBranchDelete(arg: any | undefined): arg is Git.Options.BranchCommand.Delete;
    /**
     * `true` if the argument is an option for creating a new branch in the repository.
     */
    function isBranchCreate(arg: any | undefined): arg is Git.Options.BranchCommand.Create;
    /**
     * `true` if the argument is an option for listing the branches in a repository.
     */
    function isBranchList(arg: any | undefined): arg is Git.Options.BranchCommand.List;
    /**
     * `true` if the argument is an option for checking out a new local branch.
     */
    function isBranchCheckout(arg: any | undefined): arg is Git.Options.Checkout.CheckoutBranch;
    /**
     ...
     * Otherwise, `false`.
     */
    function isRepositoryDoesNotExistError(error: any | undefined): boolean;
    /**
     * Maps the raw status text from Git to a Git file status enumeration.
     */
    function mapStatus(rawStatus: string): GitFileStatus;
    /**
     * `true` if the argument is a raw Git status with similarity percentage. Otherwise, `false`.
     */
    function isSimilarityStatus(rawStatus: string): boolean;
}
