...
var GitLocatorImpl = /** @class */ (function () {
    ...
    GitLocatorImpl.prototype.doLocate = function (basePath, context) {
        var _this = this;
        var realBasePath = fs.realpathSync(basePath);
        if (context.visited.has(realBasePath)) {
            return Promise.resolve([]);
        }
        context.visited.set(realBasePath, true);
        return new Promise(function (resolve) {
            fs.stat(realBasePath).then(function (stat) { return __awaiter(_this, void 0, void 0, function () {
                var progress_1, paths, repositoryPaths_1;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, findGitRepositories(realBasePath, function (repositories) {
                                    ...
                                    if (context.maxCount >= 0 && progress_1.length >= context.maxCount) {
                                        resolve(progress_1.slice(0, context.maxCount).map(GitLocatorImpl.map));
                                    }
                                })];
                        case 1:
                            paths = _a.sent();
                            ...
                            resolve(this.locateFrom(function (newContext) { return _this.generateNested(repositoryPaths_1, newContext); }, context, repositoryPaths_1));
                            _a.label = 2;
    ...
    GitLocatorImpl.prototype.generateNested = function (repositoryPaths, context) {
        var e_1, _a, repositoryPaths_2, repositoryPaths_2_1, repository, e_1_1;
    ...
    GitLocatorImpl.prototype.generateRepositories = function (repositoryPath, files, context) {
        var e_2, _a, files_1, files_1_1, file, e_2_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, 6, 7]);
    ...
    GitLocatorImpl.prototype.locateFrom = function (generator, parentContext, initial) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3, _a, result, context, _b, _c, locateRepositories, repositories, e_3_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        context = __assign({}, parentContext, { maxCount: parentContext.maxCount - result.length });
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 6, 7, 8]);
                        _b = __values(generator(context)), _c = _b.next();
                        _d.label = 2;
                    case 2:
                        if (!!_c.done) return [3 /*break*/, 5];
                        locateRepositories = _c.value;
