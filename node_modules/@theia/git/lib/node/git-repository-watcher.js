...
var GitRepositoryWatcher = /** @class */ (function () {
    function GitRepositoryWatcher() {
        this.onStatusChangedEmitter = new core_1.Emitter();
    ...
    GitRepositoryWatcher.prototype.watch = function () {
        ...
        if (this.toDispose.disposed) {
            ...
            this.toDispose.push(core_1.Disposable.create(function () {
                _this.logger.info('Stopped watching the git repository:', _this.options.repository.localUri);
                _this.clear();
            }));
        }
        this.schedule(true);
    ...
    GitRepositoryWatcher.prototype.schedule = function (initial, delay) {
        var _this = this;
        if (initial === void 0) { initial = false; }
        if (delay === void 0) { delay = initial ? 0 : 5000; }
        ...
        this.watchTimer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            var syncInitial;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.watchTimer = undefined;
                        syncInitial = this.initial;
                        this.initial = false;
                        return [4 /*yield*/, this.syncStatus(syncInitial)];
                    case 1:
                        if (_a.sent()) {
                            this.schedule();
                        }
    ...
    GitRepositoryWatcher.prototype.clear = function () {
        if (this.watchTimer) {
            clearTimeout(this.watchTimer);
            this.watchTimer = undefined;
        }
    };
    GitRepositoryWatcher.prototype.syncStatus = function (initial) {
        if (initial === void 0) { initial = false; }
        return __awaiter(this, void 0, void 0, function () {
            var source, newStatus, oldStatus, error_1, localUri;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (initial || !common_1.WorkingDirectoryStatus.equals(newStatus, oldStatus)) {
                            this.status = newStatus;
                            this.onStatusChangedEmitter.fire({ source: source, status: newStatus, oldStatus: oldStatus });
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
