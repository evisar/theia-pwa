...
var GitBlameParser = /** @class */ (function () {
    ...
    GitBlameParser.prototype.createFileBlame = function (uri, blameEntries, commitBody) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3, _a, commits, lines, blameEntries_1, blameEntries_1_1, entry, sha, commit, _b, lineCount, lineOffset, line, e_3_1, fileBlame;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        try {
                            if (blameEntries_1_1 && !blameEntries_1_1.done && (_a = blameEntries_1.return)) _a.call(blameEntries_1);
                        }
...
var DugiteGit = /** @class */ (function () {
    ...
    DugiteGit.prototype.repositories = function (workspaceRootUri, options) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4, _a, workspaceRootPath, repositories, containingPath, maxCount, _b, _c, repositoryPath, e_4_1;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = __read.apply(void 0, [_b.sent(), 2]), exec = _a[0], env = _a[1];
                        return [2 /*return*/, this.manager.run(repository, function () {
                                return reset_1.reset(repositoryPath, mode, options.mode ? options.mode : 'HEAD', { exec: exec, env: env });
                            })];
                }
            });
        });
    ...
    DugiteGit.prototype.log = function (repository, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, args, range, maxCount, placeholders, file, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.ready.promise];
                    case 1:
    ...
    DugiteGit.prototype.lsFiles = function (repository, uri, options) {
        return __awaiter(this, void 0, void 0, function () {
            var args, file, successExitCodes, expectedErrors, result, exitCode;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ready.promise];
                    case 1:
                        ...
                        expectedErrors = new Set([common_1.GitError.OutsideRepository]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = __read.apply(void 0, [_b.sent(), 2]), exec = _a[0], env = _a[1];
                        return [4 /*yield*/, git_1.git(['remote'], repositoryPath, 'remote', { exec: exec, env: env })];
                    case 3:
                        result = _b.sent();
                        out = result.stdout || '';
