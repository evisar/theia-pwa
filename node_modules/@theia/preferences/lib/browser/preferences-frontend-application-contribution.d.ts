...
export declare class PreferencesFrontendApplicationContribution implements FrontendApplicationContribution {
    jsonSchemaStore: JsonSchemaStore;
    schemaProvider: PreferenceSchemaProvider;
    inmemoryResources: InMemoryResources;
    onStart(): void;
}
//# sourceMappingURL=preferences-frontend-application-contribution.d.ts.map