...
var FileSystemNode = /** @class */ (function () {
    ...
    FileSystemNode.prototype.updateContent = function (file, contentChanges, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _uri, stat, encoding, content, newContent, newStat;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _uri = new uri_1.default(file.uri);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, fs.writeFile(file_uri_1.FileUri.fsPath(_uri), newContent, { encoding: encoding })];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.doGetStat(_uri, 1)];
                    case 5:
    ...
    FileSystemNode.prototype.move = function (sourceUri, targetUri, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doMove(sourceUri, targetUri, options)];
                    case 1:
                        result = _a.sent();
                        if (this.client) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        stat = _a.sent();
                        if (stat) {
                            throw filesystem_1.FileSystemError.FileExists(uri, 'Error occurred while creating the directory.');
                        }
