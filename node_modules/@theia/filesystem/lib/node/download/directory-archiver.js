...
var DirectoryArchiver = /** @class */ (function () {
    ...
    DirectoryArchiver.prototype.findCommonParents = function (uris) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, e_2, _b, map, uris_1, uris_1_1, uri, containerUri, containerUriStr, _c, _d, knownContainerUri, entries, collapsed, knownContainerUris, i, j, left, right, commonParent, leftEntries, rightEntries, e_1_1;
                    ...
                    case 3:
                        ...
                        if (map.has(containerUriStr)) {
                            ...
                            try {
                                ...
                                for (_c = __values(Array.from(map.keys()).sort(function (left, right) { return right.length - left.length; })), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    knownContainerUri = _d.value;
    ...
    DirectoryArchiver.prototype.closestCommonParentUri = function (left, right) {
        ...
        try {
            for (var allLeft_1 = __values(allLeft), allLeft_1_1 = allLeft_1.next(); !allLeft_1_1.done; allLeft_1_1 = allLeft_1.next()) {
                ...
                try {
                    for (var allRight_1 = __values(allRight), allRight_1_1 = allRight_1.next(); !allRight_1_1.done; allRight_1_1 = allRight_1.next()) {
