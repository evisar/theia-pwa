 ...
 */
export declare const FileShouldOverwrite: unique symbol;
...
export declare class DispatchingFileSystemClient implements FileSystemClient {
    readonly clients: Set<FileSystemClient>;
...
export declare namespace FileStat {
    function is(candidate: object): candidate is FileStat;
