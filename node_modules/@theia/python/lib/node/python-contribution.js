...
var PythonContribution = /** @class */ (function (_super) {
    ...
    PythonContribution.prototype.start = function (clientConnection) {
        var command = 'python';
        var args = ['-m', 'pyls'];
        var pythonLsCommand = process.env.PYTHON_LS_COMMAND;
        if (pythonLsCommand) {
            command = pythonLsCommand;
            args = utils_1.parseArgs(process.env.PYTHON_LS_ARGS || '');
        }
        var serverConnection = this.createProcessStreamConnection(command, args, this.getSpawnOptions());
        this.forward(clientConnection, serverConnection);
    };
    PythonContribution.prototype.getSpawnOptions = function () {
        return undefined;
    };
