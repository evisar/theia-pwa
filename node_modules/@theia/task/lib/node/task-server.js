...
var TaskServerImpl = /** @class */ (function () {
    ...
    TaskServerImpl.prototype.getTasks = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, taskInfo, tasks, tasks_1, tasks_1_1, task, _b, _c, e_1_1;
    ...
    TaskServerImpl.prototype.run = function (taskConfiguration, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var runner, task, taskInfo;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        task = _a.sent();
                        task.onExit(function (event) {
                            _this.taskManager.delete(task);
                            _this.fireTaskExitedEvent(event);
                        });
                        return [4 /*yield*/, task.getRuntimeInfo()];
                    case 2:
                        taskInfo = _a.sent();
