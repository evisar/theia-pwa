    ...
    Object.defineProperty(ApplicationPackage.prototype, "resolveModule", {
        ...
        get: function () {
            if (!this._moduleResolver) {
                ...
                if (environment_1.environment.electron.is() && !environment_1.environment.electron.isDevMode()) {
                    this._moduleResolver = function (modulePath) { return require.resolve(modulePath); };
                }
                else {
