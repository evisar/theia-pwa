...
var NodeMetricsContribution = /** @class */ (function () {
    function NodeMetricsContribution() {
    }
    NodeMetricsContribution.prototype.getMetrics = function () {
        return prom.register.metrics().toString();
    };
    NodeMetricsContribution.prototype.startCollecting = function () {
    ...
    return NodeMetricsContribution;
}());
