...
exports.JavaPreferences = Symbol('JavaPreferences');
function createJavaPreferences(preferences) {
    return preferences_1.createPreferenceProxy(preferences, exports.javaDebugPreferenceSchema);
}
exports.createJavaPreferences = createJavaPreferences;
function bindJavaPreferences(bind) {
    bind(exports.JavaPreferences).toDynamicValue(function (ctx) {
...
exports.bindJavaPreferences = bindJavaPreferences;
//# sourceMappingURL=java-preferences.js.map