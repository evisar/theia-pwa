...
var DebugAdapterContributionRegistry = /** @class */ (function () {
    ...
    DebugAdapterContributionRegistry.prototype.getContributions = function (debugType) {
        var e_1, _a, _b, _c, contribution, e_1_1;
    ...
    DebugAdapterContributionRegistry.prototype.getDebuggersForLanguage = function (language) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3, _a, debuggers, _b, _c, contribution, label, _d, e_3_1;
    ...
    DebugAdapterContributionRegistry.prototype.provideDebugConfigurations = function (debugType, workspaceFolderUri) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4, _a, configurations, _b, _c, contribution, result, e_5, e_4_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        configurations = [];
                    ...
                    case 1:
                        ...
                        _b = __values(this.getContributions(debugType)), _c = _b.next();
                        _d.label = 2;
                    case 2:
                        if (!!_c.done) return [3 /*break*/, 7];
                        contribution = _c.value;
    ...
    DebugAdapterContributionRegistry.prototype.resolveDebugConfiguration = function (config, workspaceFolderUri) {
        return __awaiter(this, void 0, void 0, function () {
            var e_6, _a, current, _b, _c, contribution, next, e_7, e_6_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        current = config;
                    ...
                    case 1:
                        _d.trys.push([1, 8, 9, 10]);
                        _b = __values(this.getContributions(config.type)), _c = _b.next();
                        _d.label = 2;
                    case 2:
                        if (!!_c.done) return [3 /*break*/, 7];
                        contribution = _c.value;
    ...
    DebugAdapterContributionRegistry.prototype.getSchemaAttributes = function (debugType) {
        return __awaiter(this, void 0, void 0, function () {
            var e_8, _a, schemas, _b, _c, contribution, _d, _e, _f, e_9, e_8_1;
    ...
    DebugAdapterContributionRegistry.prototype.getConfigurationSnippets = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_10, _a, schemas, _b, _c, contribution, _d, _e, _f, e_11, e_10_1;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        schemas = [];
                    ...
                    case 1:
                        _g.trys.push([1, 8, 9, 10]);
                        _b = __values(this.getContributions('*')), _c = _b.next();
                        _g.label = 2;
                    case 2:
                        if (!!_c.done) return [3 /*break*/, 7];
                        contribution = _c.value;
    ...
    DebugAdapterContributionRegistry.prototype.provideDebugAdapterExecutable = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var e_12, _a, _b, _c, contribution, executable, e_12_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 5, 6, 7]);
    ...
    __decorate([
        inversify_1.inject(core_1.ContributionProvider), inversify_1.named(debug_model_1.DebugAdapterContribution),
