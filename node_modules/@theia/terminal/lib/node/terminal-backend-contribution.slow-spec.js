...
describe('Terminal Backend Contribution', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    container = terminal_test_container_1.createTerminalTestContainer();
                    application = container.get(backend_application_1.BackendApplication);
    ...
    it('is data received from the terminal ws server', function () { return __awaiter(_this, void 0, void 0, function () {
        var terminalId;
        return __generator(this, function (_a) {
            switch (_a.label) {
