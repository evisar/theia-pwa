            ...
            switch (_a.label) {
                ...
                case 8:
                    ...
                    if (!acceptableExitCode) {
                        gitError = dugite_1.GitProcess.parseError(result.stderr) || undefined;
                        if (!gitError) {
                            gitError = dugite_1.GitProcess.parseError(result.stdout) || undefined;
                        }
                    }
...
function getDescriptionForError(error) {
    switch (error) {
        case dugite_1.GitError.SSHKeyAuditUnverified:
            return 'The SSH key is unverified.';
        case dugite_1.GitError.SSHAuthenticationFailed:
        case dugite_1.GitError.SSHPermissionDenied:
        case dugite_1.GitError.HTTPSAuthenticationFailed:
        ...
        case dugite_1.GitError.SubmoduleRepositoryDoesNotExist:
            return 'A submodule points to a location which does not exist.';
        case dugite_1.GitError.InvalidSubmoduleSHA:
            return 'A submodule points to a commit which does not exist.';
        case dugite_1.GitError.LocalPermissionDenied:
            return 'Permission denied.';
        case dugite_1.GitError.InvalidMerge:
            return 'This is not something we can merge.';
        case dugite_1.GitError.InvalidRebase:
            return 'This is not something we can rebase.';
        case dugite_1.GitError.NonFastForwardMergeIntoEmptyHead:
            return 'The merge you attempted is not a fast-forward, so it cannot be performed on an empty branch.';
        case dugite_1.GitError.PatchDoesNotApply:
            return 'The requested changes conflict with one or more files in the repository.';
        case dugite_1.GitError.BranchAlreadyExists:
            return 'A branch with that name already exists.';
        case dugite_1.GitError.BadRevision:
            return 'Bad revision.';
        case dugite_1.GitError.NotAGitRepository:
            return 'This is not a git repository.';
        case dugite_1.GitError.ProtectedBranchForcePush:
            return 'This branch is protected from force-push operations.';
        case dugite_1.GitError.ProtectedBranchRequiresReview:
        ...
        case dugite_1.GitError.PushWithFileSizeExceedingLimit:
        ...
        case dugite_1.GitError.HexBranchNameRejected:
