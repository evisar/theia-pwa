 ...
 *                           'git push'.
 */
export declare function push(repositoryPath: string, remote: string, localBranch: string, remoteBranch?: string, options?: IGitExecutionOptions, progressCallback?: (progress: IPushProgress) => void): Promise<void>;
