...
function getStatus(repositoryPath, noOptionalLocks, limit, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var e_1, _a, args, version, canUseNoOptionalLocks, e_2, parsed, _b, rawMajor, rawMinor, major, minor, result, files, existingFiles, currentBranch, currentUpstreamBranch, currentTip, branchAheadBehind, _c, entries, incomplete, _loop_1, entries_1, entries_1_1, entry, workingDirectory;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    e_2 = _d.sent();
                    console.error('Error ocurred when determining the Git version.', e_2);
                    return [3 /*break*/, 4];
                case 4:
                    if (!version) {
                        ...
                        _b = __read(parsed.split('.'), 2), rawMajor = _b[0], rawMinor = _b[1];
                ...
                case 7:
                    ...
                    _c = status_parser_1.parsePorcelainStatus(result.stdout, limit), entries = _c.entries, incomplete = _c.incomplete;
