 ...
 * info in a commit.
 */
export declare class CommitIdentity {
     ...
     */
    static parseIdentity(identity: string): CommitIdentity | null;
    constructor(name: string, email: string, date: Date, tzOffset?: number);
}
