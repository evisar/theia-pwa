            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, languageClient.sendRequest(browser_1.CodeActionRequest.type, {
                                textDocument: {
...
var CodeActionPalettePopupProvider = /** @class */ (function () {
    ...
    CodeActionPalettePopupProvider.prototype.getPopupModel = function (action, rootElement) {
        return __awaiter(this, void 0, void 0, function () {
            var rangeString, range_1, codeActions, buttons_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rangeString = rootElement['range'];
                        if (!(rangeString !== undefined)) return [3 /*break*/, 2];
                        range_1 = ranged_1.toLsRange(rangeString);
                        return [4 /*yield*/, this.codeActionProvider.getCodeActions(range_1, 'sprotty.create')];
                    case 1:
                        codeActions = _a.sent();
                        if (codeActions) {
                            buttons_1 = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        diagramServer = _a.sent();
                        workspace = diagramServer.getWorkspace();
                        ...
                        if (codeActions) {
                            for (_i = 0, codeActions_1 = codeActions; _i < codeActions_1.length; _i++) {
                                ...
                                if (browser_1.CodeAction.is(codeAction) && codeAction.edit)
                                    return [2 /*return*/, new workspace_edit_command_1.WorkspaceEditAction(codeAction.edit, workspace)];
                            }
                        }
                        _a.label = 3;
                    case 3: return [2 /*return*/, new lib_1.SetPopupModelAction(lib_1.EMPTY_ROOT)];
                }
            });
        });
    };
...
}(lib_1.PopupHoverMouseListener));
exports.PaletteMouseListener = PaletteMouseListener;
//# sourceMappingURL=code-action-palette.js.map